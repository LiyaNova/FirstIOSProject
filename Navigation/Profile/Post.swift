...
struct Post {
    ...
    static func makePost() -> [Post] {
        var post = [Post]()
        post.append(Post(author: "netflix.official", image: UIImage(named: "dark")!, likes: 300, views: 400))
        ...
        post.append(Post(author: "The Art Newspaper", image: UIImage(named: "louvre")!, likes: 600, views: 1000))
        return post
    }
